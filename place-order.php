                ...
                <div class="card-panel">
                  <div class="row">
                    <form class="formValidate col s12 m12 l6" id="formValidate" method="post" action="confirm-order.php" novalidate="novalidate">
                      ...
                      <div class="row">
                        <div class="input-field col s12">
                          <label for="payment_type">Select Dilevery Slot</label><br><br>
                          <select id="time_slot" name="time_slot">
                            <?php $result = mysqli_query($con, "SELECT * FROM delevery");
                            while ($row = mysqli_fetch_array($result)) {
                              $fill = 10 - $row['fill'];
                              $slot = $row['slot'];
                              $id = $row['id'];
                            ...
                            ?>
                              <option value="<?php echo $id ?>" <?php if ($fill < 1) echo 'disabled'; ?>><?php echo $slot ?> <div style="text-align:right; "> (<?php echo $fill ?> places left)</div>
                              </option>

                              <!-- <option value="Cash On Delivery" <?php //if (!$verified) echo 'disabled'; 
